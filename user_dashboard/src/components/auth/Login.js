...
const carouselItems = [
    {
        img: carouselImg1,
        caption: 'Play classics like Scrabble, WHOT, Chess, and Snooker with friends and family while betting to win big.'
    }
]
    ...
    const displayCarouselItems = carouselItems.map((item, i) => {
        ...
        return (
            ...
            > 
                ...
                <p className='small-txt txt-F7FAFF font-weight-400 line-height-30 m-0 p-0 font-family-poppins text-center'>{caption}</p>
            </div>
        )
    })
        ...
        <div className='register-bg py-4 px-lg-5 px-md-5 px-3'>
            ...
            <div className='d-lg-flex d-md-flex d-block justify-content-between align-items-center'>
                <div className='col-lg-5 col-md-12 col-12'>
                    <h1 className='m-0 p-0 extra-large-txt txt-FFF font-weight-500 mb-4 font-family-quantico'>Log In to your <span className='register-acct-txt'>Account</span></h1>
                    <p className='m-0 p-0 small-txt txt-FFF opacity-_7 font-family-poppins font-weight-300 mb-4'>Welcome back! Select method to log in:</p>                    
                    ...
                    <div className='d-flex align-items-center justify-content-between mb-5'>
                        <div className='col-lg-6 col-md-6 col-6'>
                            <div className='col-lg-11 col-md-11 col-11 p-2 d-flex align-items-center justify-content-center clickable login-other-options-container'>
                                ...
                                <p className='px-1 txt-FEFEFF m-0 p-0 font-family-inter small-txt font-weight-400 line-height-24'>Sign in with Google</p>
                            </div>
                        </div>
                        <div className='col-lg-6 col-md-6 col-6 d-flex align-items-center justify-content-end'>
                            <div className='col-lg-11 col-md-11 col-11 p-2 d-flex align-items-center justify-content-center clickable login-other-options-container'>
                                ...
                                <p className='px-1 txt-FEFEFF m-0 p-0 font-family-inter small-txt font-weight-400 line-height-24'>Sign in with Apple</p>
                            </div>                    
                        </div>    
                    </div>
                    ...
                    <div className='mb-5 py-2 d-flex align-items-center justify-content-between'>
                        ...
                        <p className='m-0 p-0 regular-txt font-family-poppins font-weight-300 txt-FFF opacity-_7'>Or</p>
                        <div className='login-or-line col-lg-5 col-md-5 col-5' />
                    </div>
                    ...
                    <div className='d-flex justify-content-between mb-5'>
                        ...
                        <p onClick={goToForgotPassword} className='m-0 p-0 small-txt font-family-poppins txt-BD3193 font-weight-300 clickable'>Forgot Password?</p>
                    </div>
                    ...
                    <div className='w-100 mb-3'>
                        ...
                        >
                            <p className='p-0 m-0 small-txt txt-FFF font-weight-500 font-family-poppins mx-1'>Login</p>
                    ...
                    <div className='d-flex align-items-center justify-content-center'>
                        <p onClick={goToRegister} className='clickable font-weight-400 small-txt txt-FFF text-start font-family-poppins m-0 p-0 mx-2'>
                            Don’t have an account? <span className='txt-BD3193 opacity-_7'>Register</span>.
                        </p>
                    </div>
                </div>
