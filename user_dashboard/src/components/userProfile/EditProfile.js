        ...
        <div className='dashboard py-lg-5 py-md-5 my-md-3 my-lg-3 my-0 py-2'>
            <div className="d-lg-flex d-md-flex d-block align-items-center justify-content-between mb-5">
                <div className="d-flex align-items-center">
                    <div>
                        <div className={`${bgClass} user-profile-edit-profile-img-container rounded-circle d-flex flex-column align-items-center justify-content-center p-1`}>
                            <img src={profile} />
                        </div>
...

            {
                isEditting &&
                    ...
                    >
                        <p className='p-0 m-0 small-txt txt-FFF font-weight-500 font-family-poppins mx-1'>Save Changes</p>
