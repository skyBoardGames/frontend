            ...
            >
                <div className="py-4 px-4 mx-3">
                    ...
                    <div className="withdraw-modal-balance-container p-3 mb-4">
                        <p className="m-0 p-0 mb-2 font-weight-500 small-txt font-family-poppins txt-FFF text-center">Available Balance</p>
                        <h4 className="m-0 p-0 regular-txt txt-FFF font-weight-700 font-family-poppins text-center">₦52,000.00</h4>
                    </div>
                    ...
                    >
                        <p className='p-0 m-0 small-txt txt-FFF font-weight-500 font-family-poppins mx-1'>Withdraw</p>
