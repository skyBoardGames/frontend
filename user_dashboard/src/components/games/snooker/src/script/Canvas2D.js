...
Object.defineProperty(Canvas2D_Singleton.prototype, "scale",
    {
        get: function () {
            ...
            // 3000 1418
            if(isMobile) {
              // console.log(Game.size.y, this._canvas.height);
              // return new Vector2(this._canvas.height / Game.size.y, this._canvas.width / Game.size.x);
              return new Vector2(this._canvas.width / Game.size.x,
                  this._canvas.height / Game.size.y);
              // return new Vector2(this._canvas.height / Game.size.x,
              //     this._canvas.width / Game.size.y);
            }
            else {
              return new Vector2(this._canvas.width / Game.size.x,
                  this._canvas.height / Game.size.y);
...
Canvas2D_Singleton.prototype.resizeMobile = function () {
    ...
    var gameArea = Canvas2D._div;
    var widthToHeight = Game.size.x / Game.size.y;
    // var newWidth = Game.gameWorld == undefined ? window.innerWidth : window.innerWidth - 300;
