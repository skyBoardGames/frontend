    ...
    const displayCategories = categories.map((category, i) => {
        ...
        return (
            <div
                ...
                className={`${isActive ? 'bg-73CD02' : 'bg-transparent'} mb-lg-0 mb-md-0 mb-3 col-lg-auto col-md-auto col-5 clickable chat-users-section-filter-container col-lg-1 d-flex align-items-center justify-content-center px-5 py-2`}
            >
                <p className={`${isActive ? 'txt-000' : 'txt-73CD02'} m-0 p-0 font-weight-600 font-family-poppins line-height-24 small-txt text-capitalize`}>{name}</p>
            </div> 
        )
    })
                ...
                <div style={{ backgroundColor: '#130828', overflowY: 'auto', maxHeight: '100vh' }} className='navContainer w-100 h-100'>
                    <div className='w-100 h-100 navContainer p-4'>
                        <div className='d-flex align-items-center mb-5 justify-content-between'>
                            <h1 className='m-0 p-0 font-weight-700 font-family-quantico txt-large txt-FFF'>Filter <span className='txt-73CD02'>Users</span></h1>               
                        ...
                        <div className="">
                            ...
                            >
                                <div className='m-0 p-0 d-flex align-items-center'>
                                    <CustomSvg name={'search'} color={'#000'} />
                                </div>                                
                                <p className='p-0 m-0 small-txt txt-000 font-weight-500 font-family-poppins mx-2'>Search</p>
                            </button>                                                                           
                        </div>                     
                    </div>
                </div>
