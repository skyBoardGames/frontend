        ...
        <div className='register-bg py-4 px-lg-5 px-md-5 px-3'>
            ...
            <div className='d-lg-flex d-md-flex d-block justify-content-between align-items-center'>
                <div className='col-lg-5 col-md-12 col-12'>
                    <h1 className='m-0 p-0 extra-large-txt txt-FFF font-weight-500 mb-4 font-family-quantico'>Register your <span className='register-acct-txt'>Account</span></h1>
                    <p className='m-0 p-0 small-txt txt-FFF opacity-_7 font-family-poppins font-weight-300 mb-4'>New  here! Create a new account</p>
                    ...
                    <div className='d-flex justify-content-start mb-5'>
                        <div className='d-flex align-items-center'>
                            ...
                            <p className='font-weight-400 small-txt txt-FFF text-start font-family-poppins m-0 p-0 mx-2'>
                                By checking the box you agree to our <span className='txt-73CD02 opacity-_7'>Terms</span> and <span className='txt-73CD02 opacity-_7'>Conditions</span>.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className='w-100 mb-3'>
                        ...
                        >
                            <p className='p-0 m-0 small-txt txt-000 font-weight-500 font-family-poppins mx-1'>Register</p>
                            <div className='m-0 p-0 mx-2 d-flex align-items-center'>
                                <CustomSvg name={'arrow-right'} color="#000" width={24} height={24} />
                            </div>
                        </button>
                    </div>

                    <div onClick={goToLogin} className='d-flex align-items-center justify-content-center'>
                        <p className='clickable font-weight-400 small-txt txt-FFF text-start font-family-poppins m-0 p-0 mx-2'>
                            Already have an account? <span className='txt-73CD02 opacity-_7'>Login</span>.
                        </p>
                    </div>
                </div>
