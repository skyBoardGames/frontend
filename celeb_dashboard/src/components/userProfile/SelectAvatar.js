...
export default function SelectAvatar({ isProfileRoute }){
    ...
    const displayAvatars = avatars.map((avatar, i) => {
        ...
        return (
            <div 
                ...
                className={`col-lg-auto col-md-auto col-auto ${bgClass} ${isSelected && 'user-profile-edit-profile-img-container'} clickable mb-4 rounded-circle mx-lg-4 mx-md-4 mx-2 d-flex align-items-center justify-content-center p-1`}
            >
    ...
    const onBtnClick = () => isProfileRoute ? goToEditProfile() : goToDashboard()
    ...
    return (
        <div className='email-verify-bg py-4 px-lg-5 px-md-5 px-3'>
            ...
            <div className='d-flex align-items-center justify-content-center py-0'>
                <div className={`${isProfileRoute ? 'col-lg-12' : 'col-lg-10'} d-flex flex-column align-items-center justify-content-center`}>
                    <h1 className='m-0 p-0 mb-4 font-weight-700 font-family-quantico txt-FFF extra-large-txt text-center'>Select  <span className='email-verify-email-txt'>Avatar</span></h1>                        

                    <p className='m-0 p-0 mb-5 opacity-_7 font-family-poppins txt-small font-weight-300 txt-FFF text-center'>Select an avatar as your profile picture</p>
                    ...
                    <button 
                        ...
                        className='w-lg-50 w-md-50 w-75 bg-73CD02 d-flex align-items-center justify-content-center p-2 mb-5'
                    >
