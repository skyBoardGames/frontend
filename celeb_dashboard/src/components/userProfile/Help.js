            ...
            <div className="d-flex w-100 align-items-center justify-content-center">
                <div className="col-lg-10">
                    ...
                    <div className='w-100 mb-3'>
                        <button 
                            className='w-100 bg-73CD02 d-flex align-items-center justify-content-center p-3'
                        >
                            <p className='p-0 m-0 small-txt txt-000 font-weight-500 font-family-poppins mx-1'>Send</p>
