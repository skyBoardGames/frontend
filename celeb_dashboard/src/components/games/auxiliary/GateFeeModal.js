...
export default function GateFeeModal({ modalProps, openPrices }){
    ...
    if(modalProps){
        ...
        const toggleUseFee = () => setUseFee(prev => prev == 'yes' ? 'no' : 'yes')
        ...
        return (
            ...
            >
                <div className="py-4 px-4 mx-3">
                    ...
                    <h4 className="p-0 m-0 mb-4 txt-130828 text-center font-family-quantico font-weight-700 line-height-30 letter-spacing-_32 medium-txt">Gate Fee</h4>
                    ...
                    <div className="d-flex align-items-center mb-3">
                        <div onClick={toggleUseFee} className="clickable d-flex align-items-center">
                            {
                                useFee == 'no'
                                ?
                            ...
                            <p className="m-0 p-0 mx-2 txt-000 font-weight-400 font-family-poppins regular-txt">Yes</p>
                        </div>

                        <div onClick={toggleUseFee} className="clickable mx-4 d-flex align-items-center">
                            {
                                useFee == 'yes'
                                ?
                                    <MdOutlineCheckBoxOutlineBlank color="#000" size={20} />
                            ...
                            <p className="m-0 mx-2 p-0 txt-000 font-weight-400 font-family-poppins regular-txt">No</p>
                        </div>                        
                    </div>
