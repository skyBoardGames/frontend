...
export default function ParticipatingUsers(){
  ...
  const goToWaitingRoom = () => navigateTo(`/games/waiting-room/${gameId}`, { reRoutePath: `/tournaments/play/user-pairing/${gameId}` })
  ...
  const displayParticipatingUsers = [...allUsers, ...allUsers, ...allUsers].map((user, i) => {
    ...
    return (
      ...
      >
        ...
        <h5 className='m-0 p-0 mb-1 text-center txt-FFF small-txt font-weight-600 font-family-poppins'>{name}</h5>
        <p className='m-0 p-0 text-center txt-EAD3AB extra-small-txt font-weight-300 font-family-poppins'>{wins} wins</p>
      </div>
    )
  })
                  ...
                  showParticipatingUsers && 
                    <div>
                      <div className='d-flex align-items-center justify-content-between mb-3'>
                        <h1 className='m-0 p-0 font-weight-700 font-family-quantico txt-large txt-FFF'>Participating <span className='txt-73CD02'>Users</span></h1>  
