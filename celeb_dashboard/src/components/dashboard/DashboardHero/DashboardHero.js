    ...
    <div className="d-flex w-100 align-items-center justify-content-center">
      <div className="availablegamescontainer">
        ...
        <div className="d-flex  combinations mb-5">
          <div className="Availabletitle font-family-poppins ">
            Available Games
          </div>
                ...
                <div
                  className={`${
                    gamesCount === 5
                      ? "col-lg-12 col-12"
                      : "col-lg-11 col-md-11"
                  } availableContainer mt-4`}
                  id={availablegames.id}
                >
                  <img src={availablegames.img} className="mb-4" alt="" />
                  <div className="d-flex justify-content-between">
                    <div>
                      <div className="gamesname mb-2">
                        {availablegames.title}
                      </div>
                      <div className="gameswriteup font-family-poppins extra-small-txt">
                        {availablegames.caption}
                      </div>
                    </div>
                    ...
                    <div className="anchorarrow">
                      <CustomSvg
                        name="arrow-right"
                        color={availablegames.arrowColor}
                        width={"16px"}
                        height={"16px"}
                      />
                    </div>
        ...
        <div>
          <div className="d-flex justify-content-between mb-3">
            ...
            <div onClick={goToAllUsers} className="clickable">
              <p className="font-family-poppins seelink topgamersseeall">
                {" "}
                see all <CustomSvg name="arrow-right" color={"#73CD02"} />
              </p>
            </div>
          </div>
          ...
          <div className="d-flex justify-content-xxxl-center justify-content-between flex-wrap">
            {TopGamers.slice(0, usersCount).map((topgamers) => (
              <>
                <div
                  className="col-lg-auto col-md-auto col-5 d-flex flex-column align-items-center m-2"
                  id={topgamers.id}
                >
                  <div
                    className={`${topgamers.bgClass} rounded-circle p-1 mb-2`}
                  >
                    <img
                      src={topgamers.img}
                      alt={topgamers.gamersname}
                      className=""
                    />
                  </div>
                  <div className=" font-family-poppins txt-FFF">
                    {topgamers.gamersname}
                  </div>
                </div>
              </>
            ))}
