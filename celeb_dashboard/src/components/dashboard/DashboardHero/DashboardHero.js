                            ...
                            <div className='px-lg-4 px-md-4 px-2'>
                                <div className='d-flex flex-column justify-content-between carouselleft'>
                                    ...
                                    <div className='d-flex align-items-center justify-content-start'>
                                        <div onClick={playLudo} className='enterbutton px-5 py-3 clickable'>Host <CustomSvg name="arrow-right" color="black"/></div>
                                    </div>
                                </div>
                            </div>
                        </Carousel.Item>
                        ...
                        <Carousel.Item className='bg-img carousel-2-bg mb-5 p-lg-5 p-md-5 p-1'>
                            <div className='px-lg-4 px-md-4 px-2'>
                                <div className='d-flex flex-column justify-content-between carouselleft'>
                                    ...
                                    <div className='d-flex align-items-center justify-content-start'>
                                        <div onClick={playChess} className='enterbutton px-5 py-3 clickable'>Host <CustomSvg name="arrow-right" color="black"/></div>
                                    </div>
                                </div>
                            </div>
                        </Carousel.Item>
                        ...
                        <Carousel.Item className='bg-img carousel-3-bg mb-5 p-lg-5 p-md-5 p-3'>
                            <div className='px-4'>
                                <div className='d-flex flex-column justify-content-between carouselleft'>
                                    ...
                                    <div className='d-flex align-items-center justify-content-start'>
                                        <div onClick={playScrabble} className='enterbutton px-5 py-3 clickable'>Host <CustomSvg name="arrow-right" color="black"/></div>
                                    </div>
                                </div>
                            </div>
                        </Carousel.Item>
                        ...
                        <Carousel.Item className='bg-img carousel-4-bg mb-5 p-lg-5 p-md-5 p-3'>
                            <div className='px-4'>
                                <div className='d-flex flex-column justify-content-between carouselleft'>
                                    ...
                                    <div className='d-flex align-items-center justify-content-start'>
                                        <div onClick={playSnooker} className='enterbutton px-5 py-3 clickable'>Host <CustomSvg name="arrow-right" color="black" /></div>
                                    </div>
                                </div>
                            </div>
                        </Carousel.Item>
                ...
                <div className='d-flex justify-content-xxxl-center justify-content-between flex-wrap'>
                    {TopGamers.slice(0, usersCount).map((topgamers) => (
                        ...
                        <div className='col-lg-auto col-md-auto col-5 d-flex flex-column align-items-center m-2' id={topgamers.id}>
                            <div className={`${topgamers.bgClass} rounded-circle p-1 mb-2`}>
                                <img src={topgamers.img} alt={topgamers.gamersname} className=''/>
                            </div>
