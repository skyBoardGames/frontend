...
function DashboardHeader() {
    ...
    const displayNavLinks = navLinks.map((navLink, i) => {
        ...
        return (
            <p 
                key={i}
                onClick={onNavClick}
                className={`${isActive ? 'txt-73CD02' : 'txt-FFF'} clickable m-0 text-capitalize p-0 small-txt font-family-poppins navlinks mb-lg-0 mb-md-0 mb-3`}
            >
                { name }
            </p>            
        )
  ...
  return (
    <div  className='dashboard-header-bg d-flex justify-content-between align-items-center px-lg-5 px-md-5 px-3 py-lg-3 py-md-3 py-3'>
        ...
        <div onClick={goToUserProfile} className='clickable col-lg-1 d-lg-flex d-md-flex d-none align-items-center justify-content-center bg-B1DEFF profileimage'>
            <img src= {Profile} className='col-lg-12' alt= "Profile"/>
        </div>
        ...
        <Offcanvas show={showOffCanvasNav}>
            <div style={{ backgroundColor: '#130828' }} className='w-100 h-100'>
                <div className='navContainer w-100 h-100 p-4'>
                    ...
                    <div onClick={goToUserProfile} className='clickable d-flex align-items-center justify-content-center bg-B1DEFF profileimage'>
                        <img src= {Profile} className='col-lg-12' alt= "Profile"/>
                    </div>                     
                </div>
            </div>
