...
const Block = ({ activebutton, activehandler, handleclose, isOpen }) => (
  <div className="collapseright collapsible-container">
    ...
    <div className="w-100">
      <span
        className="activebutton d-flex align-items-center justify-content-center p-3 clickable"
      ...
      <>
        <div className="d-flex p-3 justify-content-between align-items-center activeall">
          <div className="d-flex justify-content-between">
            ...
            <div>
              <CustomSvg name={"laptop"} /> 33
            </div>
          </div>
          <div>
            <CustomSvg name={"planet"} />
          </div>
        </div>
        ...
        <div className="d-flex justify-content-between align-items-center activetext">
          <div className="d-flex">
            ...
            <div className="d-flex ps-2">
              Snooker Board <div className="ps-1">(6)</div>
            </div>
          </div>
          <div className="clickable">
            <CustomSvg name={"caret-down"} color="#73CD02" />
        ...
        <div className="d-flex justify-content-between align-items-center activetext">
          <div className="d-flex">
            <CustomSvg name={"ludo"} />
            <div className="d-flex ps-2">
              Ludo King <div className="ps-1">(2)</div>
            </div>
          </div>
          <div className="clickable">
            <CustomSvg name={"caret-down"} color="#73CD02" />
        ...
        <div className="d-flex justify-content-between align-items-center activetext">
          <div className="d-flex">
            ...
            <div className="d-flex ps-2">
              Chess Game <div className="ps-1">(14)</div>
            </div>
          </div>
          <div className="clickable">
            <CustomSvg name={"caret-down"} color="#73CD02" />
        ...
        <div className="d-flex justify-content-between align-items-center activetext">
          <div className="d-flex">
            ...
            <div className="d-flex ps-2">
              Scrabble Game <div className="ps-1">(10)</div>
            </div>
          </div>
          <div className="clickable">
            <CustomSvg name={"caret-down"} color="#73CD02" />
        ...
        <div className="d-flex justify-content-between align-items-center activetext">
          <div className="d-flex">
            <CustomSvg name={"whot"} />
            <div className="d-flex ps-2">
              Whot Card <div className="ps-1">(1)</div>
            </div>
          </div>
          <div className="clickable">
            <CustomSvg name={"caret-down"} color="#73CD02" />
